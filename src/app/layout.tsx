...
import { Righteous, Nunito, Handlee } from 'next/font/google'
...
const primaryFont = Nunito({ subsets: ['latin'], weight: ["200", "300", "400", "500", "600", "700", "800", "900"], display: "swap", variable: "--primary-font" })
const secondaryFont = Righteous({ subsets: ['latin'], weight: ["400"], display: "swap", variable: "--secondary-font" })
const thirdFont = Handlee({ subsets: ['latin'], weight: ["400"], display: "swap", variable: "--third-font" })
